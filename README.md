...
You can read the book at [Machine Learning Interviews Book](https://huyenchip.com/ml-interviews-book/). You can find the source code on [GitHub](https://github.com/chiphuyen/ml-interviews-book).

Over the last four years, I’ve helped many friends and students prepare for their machine learning interviews at big companies, including the good old FAAAM (Facebook, Alphabet, Amazon, Apple, Microsoft), and startups that have raised from seed round to pre-IPO. I give them mock interviews and take notes of the process they went through as well as the questions they were asked. I’ve also talked to founders, hiring managers, and recruiters at those companies about the challenges of hiring machine learning talents and where their pipelines succeed or fail at addressing those challenges.
